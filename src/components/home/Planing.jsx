    ...
    return (
        <section className='bg-linear-to-t from-[#021623] via-[#195353] to-[#021623] xl:py-37.5 md:py-20 py-10'>
            <div className="container">
                <div className="grid lg:grid-cols-[668px_1fr] grid-cols-1 xl:gap-36 lg:gap-20 md:gap-10 gap-8 justify-between xl:pb-31.75 lg:pb-20 md:pb-10 pb-8">
                    <div>
                    ...
                    <div className="flex lg:flex-row flex-col items-center justify-between xl:gap-25.25 lg:gap-16 md:gap-8 gap-6">
                ...
                <div className="grid xl:grid-cols-4 lg:grid-cols-3 md:grid-cols-2 grid-cols-1 items-center xl:gap-25.25 lg:gap-16 md:gap-8 gap-6">

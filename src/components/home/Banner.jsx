            ...
            <div className="container">
                <div>
                    ...
                    <div className='flex flex-col sm:flex-row items-start sm:items-center gap-4 md:gap-6 lg:gap-10.5 pb-6 md:pb-7 lg:pb-8.25'>
                        <Link href={"/blogs"} className='py-1.5 md:py-1.75 pr-1.5 md:pr-1.75 pl-3.5 md:pl-4.25 cursor-pointer bg-white rounded-full flex items-center gap-2 w-full sm:w-auto justify-center sm:justify-start'>
